...
<body>
    ...
    <div class="content">
        ...
        <p class="p2">
            The individual has successfully paid the required local tax for the current year and is now eligible to avail of the privileges and benefits of being a taxpayer.
        </p>
        <p class="p3">
            This Cedula is issued as a proof of payment for the local tax as required by the Barangay for various public services and transactions.
        </p>
        <p class="p4">
