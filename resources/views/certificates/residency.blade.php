...
<body>
    ...
    <div class="content">
        ...
        <p class="p2">
            The individual has been residing within the barangay for a significant period and is known as a law-abiding citizen and active community member.
        </p>
        <p class="p3">
            This certificate is issued to confirm their residency status in our barangay, as requested for the purpose of <strong>{{ $record['purpose'] }}</strong>.
        </p>
        <p class="p4">
